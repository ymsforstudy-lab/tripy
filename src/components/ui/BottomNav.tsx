...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-1/2 w-full -translate-x-1/2 border-t border-gray-10 bg-white px-[47px] pb-4 pt-3 shadow-[0px_-2px_4px_0px_rgba(0,0,0,0.04)] max-w-[390px]">
